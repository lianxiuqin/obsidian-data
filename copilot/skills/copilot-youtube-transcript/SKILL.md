...
description: 使用 Copilot Plus 获取 YouTube 视频的文字记录。当用户分享 YouTube URL 并希望获得其内容、摘要或引用时使用。需要有效的 Copilot Plus 许可证。
...
# Copilot YouTube 文字记录

通过 Copilot Plus 获取 YouTube 视频的文字记录。
